    ...
    spec = {
      {
        ...
        { "<leader>or", group = "restore/revert" },
        ...
        { "<leader>oI", opencode_call("open_input_new_session"), desc = "open input (new session)" },
        ...
        { "<leader>og", opencode_call("toggle"), desc = "toggle opencode window" },
        { "<leader>oh", opencode_call("select_history"), desc = "select from history" },
        { "<leader>oi", opencode_call("open_input"), desc = "open input window" },
        { "<leader>oo", opencode_call("open_output"), desc = "open output window" },
        { "<leader>op", opencode_call("configure_provider"), desc = "configure provider" },
        { "<leader>oq", opencode_call("close"), desc = "close opencode window" },
        { "<leader>os", opencode_call("select_session"), desc = "select session" },
        { "<leader>ot", opencode_call("toggle_focus"), desc = "toggle focus" },
        ...
        { "<leader>otr", opencode_call("toggle_reasoning_output"), desc = "toggle reasoning output" },
        { "<leader>ott", opencode_call("toggle_tool_output"), desc = "toggle tool output" },
      ...
      { "<leader>b", build_current_buffer, desc = "build", mode = "n", silent = true, nowait = true, remap = false },
      { "<leader>p", "<cmd>b#<CR>", desc = "alternate buffer", mode = "n", silent = true, nowait = true, remap = false },
      { "<leader>fy", open_yank_history, desc = "yanks", mode = "n", silent = true, nowait = true, remap = false },
      {
        "<leader>oy",
        opencode_call("add_visual_selection"),
