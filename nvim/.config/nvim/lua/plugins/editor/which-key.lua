...
return {
  ...
  opts = {
    ...
    defaults = {
      ...
      g = { "<cmd>lua vim.schedule(function() require('plugins.tools.snacks.utils').safe_lazygit() end)<cr>", "lazygit" },
      ...
      j = {
        ...
        I = { "<cmd>lua require('util.jupyter').convert_current_ipynb_to_ju()<CR>", "convert ipynb to ju.py" },
        ...
        o = { "<cmd>lua require('util.jupyter').open_current_notebook()<CR>", "open notebook in browser" },
        ...
        v = { "<cmd>lua require('util.jupyter').setup_project_venv()<CR>", "bootstrap .venv (py3.12)" },
        S = { "<cmd>lua require('util.jupyter').save_current_as_ipynb()<CR>", "save ipynb with outputs" },
      },
      L = {
        name = "list",
      },
